export const faqs = [
  ...
  },
  {
    ...
    answer: "Absolutely. Every video call is recorded and saved to your dashboard along with the notes and summary for quick access anytime.",
  },
  {
    question: "Is my data and meeting content secure?",
    answer: "Yes. We prioritize your privacy. All meetings and data are securely stored and encrypted.",
  },
  {
    question: "Can multiple team members access the same dashboard?",
    answer: "Right now, each user has their own dashboard, but team collaboration features are coming soon!",
  },
  {
    question: "What if my internet disconnects during a meeting?",
    answer: "No worries. The meeting will continue recording, and the AI will still generate notes and a summary once the session ends.",
  },
];